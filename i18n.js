...
(function () {
  ...
  var DICT = {
    zh: {
      ...
      'ws.desc': 'ConfigNexus 创意工坊组件库：15 个开源示例组件 + 组件/插件开发文档 + AI 技能包，源码托管在 GitHub，照着就能给配置大师做组件。',
      ...
      'ws.gridTag': '组件清单', 'ws.gridH': '15 个开源示例组件', 'ws.empty': '组件清单加载中…',
      ...
      'dl.ver': '最新版本 · v1.0.0', 'dl.btn': '即将提供下载',
      'dl.note': '安装包正在准备中，上线后这里会换成 Windows 安装程序（.exe）的下载按钮。可以先在 GitHub 关注更新。',
      'dl.k1': '系统', 'dl.v1': 'Windows 10 / 11', 'dl.k2': '架构', 'dl.v2': '64 位', 'dl.k3': '安装方式', 'dl.v3': 'NSIS 安装程序',
      'dl.s1h': '下载安装包', 'dl.s1p': '点击上方按钮下载 Windows 安装程序（上线后提供）。',
    ...
    en: {
      ...
      'ws.desc': 'ConfigNexus Workshop components: 15 open-source example components + component/plugin dev docs + AI skill packs, all hosted on GitHub.',
      ...
      'ws.gridTag': 'Component list', 'ws.gridH': '15 open-source example components', 'ws.empty': 'Loading components…',
      ...
      'dl.ver': 'Latest · v1.0.0', 'dl.btn': 'Download coming soon',
      'dl.note': 'The installer is being prepared. Once live, this becomes a download button for the Windows installer (.exe). Follow updates on GitHub for now.',
      'dl.k1': 'OS', 'dl.v1': 'Windows 10 / 11', 'dl.k2': 'Architecture', 'dl.v2': '64-bit', 'dl.k3': 'Installation', 'dl.v3': 'NSIS installer',
      'dl.s1h': 'Download the installer', 'dl.s1p': 'Click the button above to download the Windows installer (available after launch).',
    ...
    ja: {
      ...
      'ws.desc': 'ConfigNexus ワークショップのコンポーネント：15 個のオープンソース実例 + コンポーネント/プラグイン開発ドキュメント + AI スキルパック、すべて GitHub でホスティング。',
      ...
      'ws.gridTag': 'コンポーネント一覧', 'ws.gridH': '15 個のオープンソース実例コンポーネント', 'ws.empty': 'コンポーネントを読み込み中…',
      ...
      'dl.ver': '最新版 · v1.0.0', 'dl.btn': 'まもなく提供',
      'dl.note': 'インストーラーを準備中です。公開後はここが Windows インストーラー（.exe）のダウンロードボタンになります。今は GitHub で更新をフォローしてください。',
      'dl.k1': 'OS', 'dl.v1': 'Windows 10 / 11', 'dl.k2': 'アーキテクチャ', 'dl.v2': '64 ビット', 'dl.k3': 'インストール方式', 'dl.v3': 'NSIS インストーラー',
      'dl.s1h': 'インストーラーをダウンロード', 'dl.s1p': '上のボタンをクリックして Windows インストーラーをダウンロード（公開後に提供）。',
    ...
    ko: {
      ...
      'ws.desc': 'ConfigNexus 워크숍 컴포넌트: 오픈소스 예제 15개 + 컴포넌트/플러그인 개발 문서 + AI 스킬 팩, 모두 GitHub 호스팅.',
      ...
      'ws.gridTag': '컴포넌트 목록', 'ws.gridH': '오픈소스 예제 컴포넌트 15개', 'ws.empty': '컴포넌트 불러오는 중…',
      ...
      'dl.ver': '최신 버전 · v1.0.0', 'dl.btn': '곧 제공 예정',
      'dl.note': '설치 프로그램을 준비 중입니다. 출시되면 이곳이 Windows 설치 프로그램(.exe) 다운로드 버튼으로 바뀝니다. 지금은 GitHub에서 업데이트를 팔로우하세요.',
      'dl.k1': '운영체제', 'dl.v1': 'Windows 10 / 11', 'dl.k2': '아키텍처', 'dl.v2': '64비트', 'dl.k3': '설치 방식', 'dl.v3': 'NSIS 설치 프로그램',
      'dl.s1h': '설치 프로그램 다운로드', 'dl.s1p': '위 버튼을 클릭해 Windows 설치 프로그램을 다운로드하세요 (출시 후 제공).',
